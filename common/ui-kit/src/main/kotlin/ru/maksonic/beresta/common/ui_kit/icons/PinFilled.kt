...
/**
 * @Author maksonic on 18.05.2023
 */
val AppIcon.PinFilled: ImageVector
    get() {
        if (_pinFilled != null) {
            return _pinFilled!!
        }
        _pinFilled = materialIcon(name = "PinFilled") {
            path(
            ...
            path(
                ...
                curveTo(3.184F, 10.626F, 3.184F, 10.17F, 3.465F, 9.889F)
            ...
            path(
                ...
                lineTo(18.0F, 6.5F)
                curveTo(17.66F, 6.84F, 14.457F, 13.651F, 14.0F, 13.5F)
                curveTo(13.195F, 13.234F, 12.398F, 16.352F, 12.0F, 16.5F)
                curveTo(11.52F, 16.679F, 7.017F, 10.408F, 6.0F, 11.5F)
                lineTo(5.391F, 9.53F)
            ...
            materialPath {
                moveTo(6.912F, 14.345F)
                lineTo(8.478F, 15.911F)
                lineTo(4.172F, 20.217F)
                horizontalLineTo(2.606F)
                verticalLineTo(18.651F)
                lineTo(6.912F, 14.345F)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
                ...
                moveTo(6.912F, 13.92F)
                lineTo(8.902F, 15.911F)
                lineTo(4.296F, 20.517F)
                lineTo(2.306F, 20.517F)
                lineTo(2.306F, 18.527F)
                lineTo(6.912F, 13.92F)

                moveTo(2.606F, 18.651F)
                lineTo(6.912F, 14.345F)
                lineTo(8.478F, 15.911F)
                lineTo(4.172F, 20.217F)
                horizontalLineTo(2.606F)
                lineTo(2.606F, 18.651F)
                close()
            }
        }
        return _pinFilled!!
...
private fun IconPinFilledPreview() {
    BerestaTheme {
        Image(imageVector = AppIcon.PinFilled, contentDescription = null)
    }
}