 ...
 */
val AppIcon.FavoriteOutline: ImageVector
    get() {
        if (_favoriteOutline != null) {
            return _favoriteOutline!!
        }
        _favoriteOutline = materialIcon(name = "FavoriteOutline") {
            materialPath {
                moveTo(7.905F, 17.84F)
                lineTo(11.5F, 15.653F)
                lineTo(15.094F, 17.87F)
                lineTo(14.144F, 13.762F)
                lineTo(17.352F, 11.014F)
                lineTo(13.164F, 10.659F)
                lineTo(11.5F, 6.788F)
                lineTo(9.836F, 10.63F)
                lineTo(5.648F, 10.984F)
                lineTo(8.856F, 13.762F)
                lineTo(7.905F, 17.84F)
...
private fun IconFavoriteOutlinePreview() {
    Image(imageVector = AppIcon.FavoriteOutline, contentDescription = null)
}