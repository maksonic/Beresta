...
dependencies {
    ...
    implementation(project(module.Feature.AddTagDialog.Ui.Core.path))
    ...
    implementation(project(module.Feature.ImageViewer.Domain.path))
    implementation(project(module.Feature.ImageViewer.Ui.Api.path))
    implementation(project(module.Feature.ImageViewer.Ui.Core.path))
