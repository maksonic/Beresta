...
data class LangComponentEditor(
    ...
    @SerialName("dialog_title_wallpaper_texture_alpha_picker_bg") val dialogTitleWallpaperTextureAlphaBackgroundPicker: String,
    @SerialName("dialog_title_wallpaper_texture_alpha_picker_fg") val dialogTitleWallpaperTextureAlphaTintPicker: String,
    ...
    companion object {
        val Default = LangComponentEditor(
            ...
            dialogTitleWallpaperTextureAlphaBackgroundPicker = "Background alpha",
            dialogTitleWallpaperTextureAlphaTintPicker = "Texture alpha",
