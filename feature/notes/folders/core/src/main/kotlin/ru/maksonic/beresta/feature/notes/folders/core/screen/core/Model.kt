...
sealed class Msg : ElmMessage {
    ...
    sealed class Inner : Msg() {
        data class FetchedFoldersResult(val folders: List<NoteFolderUi>, val notes: List<NoteUi>) :
            Inner()
...
sealed class Cmd : ElmCommand {
    ...
    data class UndoRemovedFolders(
        val folders: List<NoteFolderUi>,
        val removedFolders: List<NoteFolderUi>,
        val notes: List<NoteUi>,
        val removedNotes: List<NoteUi>
    ) : Cmd()
