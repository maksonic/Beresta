...
class NoteFolderToChipMapper : Mapper<NoteFolderDomain, FilterChipUi> {
    override fun mapTo(i: NoteFolderDomain) = FilterChipUi(i.id, i.title, i.isMovedToTrash)
    override fun mapFrom(o: FilterChipUi) = NoteFolderDomain(o.id, o.title, o.isMovedToTrash)
}